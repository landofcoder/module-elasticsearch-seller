<?php
namespace Lof\ElasticsuiteSeller\Model\Seller\Indexer;

use Magento\Framework\Search\Request\DimensionFactory;
use Magento\Framework\Indexer\SaveHandler\IndexerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Lof\ElasticsuiteSeller\Model\Seller\Indexer\Fulltext\Action\Full;
...
class Fulltext implements ActionInterface, MviewActionInterface
{
     ...
     * @var string
     */
    const INDEXER_ID = 'elasticsuite_seller_fulltext';
