<?php
namespace Lof\ElasticsuiteSeller\Model\ResourceModel\Seller\Fulltext;

use Smile\ElasticsuiteCore\Search\RequestInterface;
use Smile\ElasticsuiteCore\Search\Request\BucketInterface;

class Collection extends \Lof\MarketPlace\Model\ResourceModel\Seller\Collection
{
    /**
     * @var QueryResponse
     */
    ...
    public function __construct(
        ...
        $searchRequestName = 'seller_search_container',
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->where('main_table.seller_id IN (?)', ['in' => $docIds]);
    ...
    /**
     * Load marketplace seller collection size.
     *
     * @return void
     */
    private function loadSellerCounts()
    {
